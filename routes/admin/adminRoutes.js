 ...
 */
router.post("/enable/twofa/email", securityController.enableTwofaEmail);
 ...
 */
router.post("/verify/twofa/email", securityController.verifyTwofaEmail);
 ...
 */
router.post("/change/email/request", securityController.changeEmailRequest);
 ...
 */
router.post("/change/email/verify", securityController.changeEmailVerify);
 ...
 */
router.post("/update/password", securityController.updatePassword);
